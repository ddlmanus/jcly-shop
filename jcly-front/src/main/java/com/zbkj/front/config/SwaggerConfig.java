...
//                .globalOperationParameters(pars) // 针对单个url的验证 如果需要的话
    ...
    private ApiInfo apiInfo() {
        Contact contact = new Contact("Crmeb","https://www.ddlmanus.xyz/index/java_merchant", "278437628@qq.com");
        return new ApiInfoBuilder()
                .title("Crmeb Java 多商户用户侧")
                .description("Java多商户接口文档")
                .contact(contact)
                .termsOfServiceUrl("https://www.ddlmanus.xyz/index/java_merchant")
                .version("1.4.0").build();
    }
