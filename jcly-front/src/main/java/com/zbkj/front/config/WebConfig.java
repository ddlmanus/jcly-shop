...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(frontTokenInterceptor()).
                ...
                excludePathPatterns("/api/front/user/integral/add"). //积分兑换
                ...
                excludePathPatterns("/api/front/login/mobile/aesquick").
                ...
                excludePathPatterns("/api/front/order/**").
                excludePathPatterns("api/front/unionpay/test/**").
                excludePathPatterns("api/front/unionpay/official/**").
                excludePathPatterns("/api/front/article/**").
                excludePathPatterns("/api/front/unionpay/official/front-callback").
                excludePathPatterns("/api/front/unionpay/official/notify-callback").
                ...
                excludePathPatterns("/api/front/groupbuy/activity//parent-categories").
                ...
                excludePathPatterns("/api/front/unionpay/pay").

                excludePathPatterns("/api/front/login/mobile/quick").
                excludePathPatterns("/api/front/user/center/info/menu").
                excludePathPatterns("/websocket/human-service/**").
                excludePathPatterns("/api/front/unionpay/**").
                excludePathPatterns("/api/front/unionpay/callback/ACPSample_DaiFu/backRcvResponse").
