...
public class UserController {
    ...
    @RequestMapping(value = "/integral/add", method = RequestMethod.POST)
    public CommonResult<Integer> integralAdd(@RequestBody @Validated IntegralAddRequest request){
        return CommonResult.success(userService.integralAdd(request));
    }
}
