...
public class OrderController {
    ...
    @ApiOperation(value = "通过订单号查询物流信息查询")
    @RequestMapping(value = "/logistics/info/{orderNo}", method = RequestMethod.GET)
    public CommonResult<LogisticsResultVo> getLogisticsInfoByOrderNo(@PathVariable(value = "orderNo") String orderNo) {
        return CommonResult.success(orderService.getLogisticsInfoByOrderNo(orderNo));
    }
    ...
    @ApiOperation(value = "获取用户中心转换的积分")
    @RequestMapping(value = "/user/center/integral/num", method = RequestMethod.GET)
    public CommonResult<UserIntegralReponse> userCenterIntegralNum() {
        return CommonResult.success(orderService.userCenterIntegralNum());
    }
}
