...
public class PayConstants {
    ...
    /** 支付方式-云支付 */
    public static final String PAY_TYPE_UNION_PAY = "unionpay_wechat";
    ...
    /** 支付渠道-支付宝二维码支付 */
    public static final String PAY_CHANNEL_ALI_QR_PAY = "alipayQr";
    /** 支付渠道-银联支付 */
    public static final String PAY_CHANNEL_UNION_PAY = "unionpay";
    ...
    // 银联支付回调地址
    public static final String UNION_PAY_NOTIFY_API_URI = "/api/publicly/payment/callback/unionpay";
    // 银联退款回调地址
    public static final String UNION_PAY_REFUND_NOTIFY_API_URI = "/api/publicly/payment/callback/unionpay/refund";
