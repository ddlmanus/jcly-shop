...
//    public static final Integer SMS_CONFIG_VERIFICATION_CODE_TEMP_ID = 538393;
    ...
    //阿里云短信登录模版
    public static final String SMS_CONFIG_KEY_ALIYUN_TEMPLATE_LOGIN = "sms_login";
    //阿里云短信注册模版
    public static final String SMS_CONFIG_KEY_ALIYUN_TEMPLATE_REGISTER = "sms_register";
    //阿里云短信签名名称
    public static final String SMS_CONFIG_KEY_ALIYUN_SIGN_NAME = "sign_name";
    //阿里云endpoint
    public static final String SMS_CONFIG_KEY_ALIYUN_ENDPOINT = "endpoint";
    //Region ID
    public static final String SMS_CONFIG_KEY_ALIYUN_REGION_ID = "region_id";
    //阿里云key
    public static final String SMS_CONFIG_KEY_ALIYUN_KEY = "sms_access_key";
    //阿里云secret
    public static final String SMS_CONFIG_KEY_ALIYUN_SECRET = "sms_access_secret";
    //阿里云短信修改密码模版
    public static final String SMS_CONFIG_KEY_ALIYUN_TEMPLATE_UPDATE_PASSWORD = "sms_reset_password";
    //阿里云短信修改手机号模版
    public static final String SMS_CONFIG_KEY_ALIYUN_TEMPLATE_UPDATE_PHONE = "reset_mobile";
    //阿里云短信修改支付密码模版
    public static final String SMS_CONFIG_KEY_ALIYUN_TEMPLATE_UPDATE_PAY_PASSWORD = "sms_pay";
    //阿里云短信通知模版
    public static final String SMS_CONFIG_KEY_ALIYUN_TEMPLATE_NOTICE = "sms_notice";
    ...
    /** 验证码场景-客服登录 */
    public static final String VERIFICATION_CODE_SCENARIO_CUSTOMER_SERVICE_LOGIN = "customer:service:login";
