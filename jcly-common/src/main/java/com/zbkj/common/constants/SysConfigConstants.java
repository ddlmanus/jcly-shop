...
public class SysConfigConstants {
    ...
    /** 腾讯地图Secret Key */
    public static final String CONFIG_SITE_TENG_XUN_MAP_SECRET_KEY = "tengxun_map_secret_key";
    
    /** ======================== 同城配送系统配置 ======================== */
    /** 同城配送功能开关 */
    public static final String CONFIG_CITY_DELIVERY_ENABLE = "city_delivery_enable";
    /** 同城配送自动分配配送员 */
    public static final String CONFIG_CITY_DELIVERY_AUTO_ASSIGN = "city_delivery_auto_assign";
    /** 配送员最大同时接单数 */
    public static final String CONFIG_CITY_DELIVERY_MAX_ORDERS = "city_delivery_max_orders";
    /** 配送员默认服务半径（公里） */
    public static final String CONFIG_CITY_DELIVERY_SERVICE_RADIUS = "city_delivery_service_radius";
    /** 配送超时时间（分钟） */
    public static final String CONFIG_CITY_DELIVERY_TIMEOUT_MINUTES = "city_delivery_timeout_minutes";
    /** 配送轨迹记录间隔（秒） */
    public static final String CONFIG_CITY_DELIVERY_TRACK_INTERVAL = "city_delivery_track_interval";
    /** 夜间配送时间段 */
    public static final String CONFIG_CITY_DELIVERY_NIGHT_HOURS = "city_delivery_night_hours";
    /** 配送员最低评分要求 */
    public static final String CONFIG_CITY_DELIVERY_MIN_RATING = "city_delivery_min_rating";
    /** 订单自动取消时间（分钟，无人接单） */
    public static final String CONFIG_CITY_DELIVERY_AUTO_CANCEL_MINUTES = "city_delivery_auto_cancel_minutes";
    /** 配送费用结算方式（1-即时结算，2-日结，3-周结，4-月结） */
    public static final String CONFIG_CITY_DELIVERY_SETTLEMENT_TYPE = "city_delivery_settlement_type";
    /** 地图服务缓存开关 */
    public static final String CONFIG_CITY_DELIVERY_MAP_CACHE_ENABLE = "city_delivery_map_cache_enable";
    /** 地图服务缓存过期时间（小时） */
    public static final String CONFIG_CITY_DELIVERY_MAP_CACHE_HOURS = "city_delivery_map_cache_hours";
    ...
    /** 银联支付状态 */
    public static final String CONFIG_UNION_PAY_STATUS = "union_pay_status";
    ...
    /** 物流查询类型:1-一号通，2-阿里云查询，3-快递100查询 */
    ...
    /** 快递100查询快递URL */
    public static final String LOGISTICS_QUERY_KD100_URL = "https://poll.kuaidi100.com/poll/query.do";
    /** 快递100查询快递密钥 */
    public static final String LOGISTICS_QUERY_KD100_KEY = "logistics_kd100_key";
    /** 快递100查询快递customer */
    public static final String LOGISTICS_QUERY_KD100_CUSTORER = "logistics_kd100_customer";
    
    /** ======================== 同城配送快递100集成 ======================== */
    /** 同城配送是否使用快递100查询 */
    public static final String CITY_DELIVERY_KD100_ENABLE = "city_delivery_kd100_enable";
    /** 同城配送快递100公司编码 */
    public static final String CITY_DELIVERY_KD100_COM_CODE = "city_delivery";
    /** 同城配送快递100状态映射 */
    public static final String CITY_DELIVERY_KD100_STATUS_MAPPING = "city_delivery_kd100_status_mapping";
    ...
    /** Coze知识库ID - 商品文档上传默认知识库 */
    public static final String CONFIG_COZE_PRODUCT_KNOWLEDGE_ID = "coze_product_knowledge_id";

    /** Coze知识库ID - 订单文档上传默认知识库 */
    public static final String CONFIG_COZE_ORDER_KNOWLEDGE_ID = "coze_order_knowledge_id";
    ...
    public static final String CONFIG_BOTTOM_NAVIGATION_CENTER_BUTTON_INDEX =  "bottom_navigation_center_button_index";
    public static final String CONFIG_BOTTOM_NAVIGATION_TAB_BAR_STYLE_MODE =  "bottom_navigation_tab_bar_style_mode";
    /** 用户中心我的服务布局模式 0-网格模式（4列）, 1-列表模式（1列） */
    public static final String CONFIG_USER_MENU_LAYOUT_MODE = "user_menu_layout_mode";
}
