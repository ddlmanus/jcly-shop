...
public class ProductInfoResponse implements Serializable {
    ...
    private List<ProductReplyResponse> replyList;

    @ApiModelProperty(value = "关联的种草笔记列表")
    private List<com.zbkj.common.model.community.CommunityNotes> communityNotesList;
}
