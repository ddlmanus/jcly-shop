...
public class Order implements Serializable {
    ...
    @ApiModelProperty(value = "发票状态：0-未开票，1-已申请，2-已开票")
    private Integer invoiceStatus;

    @ApiModelProperty(value = "发票申请ID")
    private Integer invoiceId;

    @ApiModelProperty(value = "砖石数量（1元10砖石）")
    private Integer diamond;
    @ApiModelProperty(value = "砖石转换后的积分")
    private Integer integral;

    @ApiModelProperty(value = "聚水潭订单号")
    private String jstOrderId;

    @ApiModelProperty(value = "Coze知识库文件ID，用于跟踪订单在知识库中的文件")
