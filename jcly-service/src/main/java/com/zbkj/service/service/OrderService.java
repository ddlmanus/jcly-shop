...
public interface OrderService extends IService<Order> {
     ...
     * 获取商户端订单各状态数量
     */
    OrderCountItemResponse getMerchantOrderStatusNum(OrderSearchRequest request,SystemAdmin systemAdmin);
     ...
     * @return Integer
     */
    Integer getPayUserNumByDate(Integer merId, String date);
     ...
     * @return 订单统计数据
     */
    OrderStatisticsResponse getMerchantOrderStatistics(Integer merId, Integer days);
     ...
     * @return 订单统计数据
     */
    OrderStatisticsResponse getPlatformOrderStatistics(Integer days);
     ...
     * @return 订单概览统计数据
     */
    OrderOverviewStatisticsResponse getOrderOverviewStatistics(OrderSearchRequest request, SystemAdmin systemAdmin);

    void updateDiamond(String orderNo);

    List<Order> selectList(LambdaQueryWrapper<Order> lambda);

    BigDecimal getPayOrderTotalAmount(int merId);

    LogisticsResultVo getLogisticsInfoByOrderNo(String orderNO);
}
