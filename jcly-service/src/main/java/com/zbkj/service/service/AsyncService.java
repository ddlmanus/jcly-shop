...
public interface AsyncService {
     ...
     * @param order
     */
    void sendJushuitanOrder(Order order);

    /**
     * 订单支付成功创建待办
     */
   void createOrderTodoForMerchant(Integer merId, String orderNo, User user);
     ...
     * @param merId 商户ID
     */
    void executeImportTask(String taskId, File tempFile, Integer merId, ConcurrentHashMap<String, Map<String, Object>> IMPORT_TASK_STATUS_MAP);
}
