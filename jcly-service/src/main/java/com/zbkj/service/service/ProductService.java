...
public interface ProductService extends IService<Product> {
     ...
     * @return Product
     */
    Product getByJstItemId(String jstItemId);
     ...
     * @return Product
     */
    Product getByJstSkuId(String jstSkuId);
   ...
   PageInfo<IntegralProductPageResponse> getIntegralProductPageByPlat(IntegralProductPageSearchRequest request);
    ...
    ProMerchantProductResponse getRecommendedProductsByProductId(Integer productId);

    List<Product> getByIdList(List<Integer> productIdList);
     ...
     * @return 排行榜列表
     */
    List<Product> getSalesRanking(PageParamRequest pageParamRequest);
     ...
     * @return 排行榜列表
     */
    List<Product> getCollectRanking(PageParamRequest pageParamRequest);
     ...
     * @return 排行榜列表
     */
    List<Product> getBrowseRanking(PageParamRequest pageParamRequest);
     ...
     * @return 排行榜列表
     */
    List<Product> getCategorySalesRanking(Integer categoryId, PageParamRequest pageParamRequest);
}
