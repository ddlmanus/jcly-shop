...
public interface GroupBuyActivityService extends IService<GroupBuyActivity> {
     ...
     * @return 拼团商品列表
     */
    PageInfo<GroupBuyActivityResponse> getGroupBuyProductListByCategoryId(GroupBuyProductCategorySearchRequest request);

    /**
     * 获取所有团购商品的父级分类列表
     * @return 父级分类列表
     */
    List<ProCategoryCacheVo> getParentCategoryIdsByGroupBuyProducts();
}
