...
//            .antMatchers(HttpMethod.OPTIONS, "/**").permitAll()
                ...
                .antMatchers("/api/publicly/config/get/front/domain").permitAll()
                .antMatchers("/api/admin/merchant/enterprise-chat/message/test/stream-get").permitAll()
                ...
                .antMatchers("/api/admin/public/dashboard/**").permitAll()
                .antMatchers("/api/admin/platform/csj/**").permitAll()
                .antMatchers("/api/scan/platform/statistics/home/**").permitAll()
                .antMatchers("/api/admin/merchant/enterprise-chat/message/stream-get").permitAll()
                // 放行WebSocket端点
