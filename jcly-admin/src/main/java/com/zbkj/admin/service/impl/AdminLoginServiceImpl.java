...
public class AdminLoginServiceImpl implements AdminLoginService {
    ...
    private SystemLoginResponse login(AjAdminLoginRequest request, Integer adminType, String ip) {
        ...
        //更新用户的在线状态
        CustomerServiceStaff customerServiceStaff = customerServiceStaffService.getByEmployeeId(systemAdmin.getId());
        if(Objects.nonNull(customerServiceStaff)){
            customerServiceStaffService.updateOnlineStatus(customerServiceStaff.getAdminId(), "ONLINE");
        }
        return response;
    }
    ...
    public Boolean logout() {
        ...
        //更新客服下线
        CustomerServiceStaff customerServiceStaff = customerServiceStaffService.getByEmployeeId(loginUserVo.getUser().getId());
        if(Objects.nonNull(customerServiceStaff)){
            customerServiceStaffService.updateOnlineStatus(customerServiceStaff.getAdminId(), "OFFLINE");
        }
        return true;
    }
