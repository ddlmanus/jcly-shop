...
public class MerchantOrderManagerServiceImpl implements MerchantOrderManagerService {
     ...
     */
    @Override
    public OrderCountItemResponse getMerchantOrderStatusNum(OrderSearchRequest request) {
        SystemAdmin systemAdmin = SecurityUtil.getLoginUserVo().getUser();
     ...
     */
    @Override
    public OrderStatisticsResponse getOrderStatistics(Integer days) {
        SystemAdmin systemAdmin = SecurityUtil.getLoginUserVo().getUser();
        return orderService.getMerchantOrderStatistics(systemAdmin.getMerId(), days);
    }
     ...
     */
    @Override
    public OrderOverviewStatisticsResponse getOrderOverviewStatistics(OrderSearchRequest request) {
        SystemAdmin systemAdmin = SecurityUtil.getLoginUserVo().getUser();
        return orderService.getOrderOverviewStatistics(request, systemAdmin);
    }
}
