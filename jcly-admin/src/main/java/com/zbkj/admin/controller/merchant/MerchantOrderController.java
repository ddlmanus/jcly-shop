...
public class MerchantOrderController {
    ...
    public CommonResult<OrderCountItemResponse> getOrderStatusNum(@Validated OrderSearchRequest request) {
   ...
   // @PreAuthorize("hasAuthority('merchant:order:statistics')")
    @LogControllerAnnotation(intoDB = true, methodType = MethodType.SELECT, description = "订单统计数据")
    @ApiOperation(value = "订单统计数据")
    @RequestMapping(value = "/statistics", method = RequestMethod.GET)
    public CommonResult<OrderStatisticsResponse> getOrderStatistics(@RequestParam(value = "days", defaultValue = "30") Integer days) {
        return CommonResult.success(merchantOrderManagerService.getOrderStatistics(days));
    }

   // @PreAuthorize("hasAuthority('merchant:order:overview:statistics')")
    @LogControllerAnnotation(intoDB = true, methodType = MethodType.SELECT, description = "订单概览统计数据")
    @ApiOperation(value = "订单概览统计数据")
    @RequestMapping(value = "/overview/statistics", method = RequestMethod.GET)
    public CommonResult<OrderOverviewStatisticsResponse> getOrderOverviewStatistics(@Validated OrderSearchRequest request) {
        return CommonResult.success(merchantOrderManagerService.getOrderOverviewStatistics(request));
    }
}
