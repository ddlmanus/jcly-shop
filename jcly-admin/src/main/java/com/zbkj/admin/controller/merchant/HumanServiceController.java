...
@Slf4j
@RestController
@RequestMapping("api/admin/merchant/human-service")
@Api(tags = "商户端 - 人工客服管理")
public class HumanServiceController {
   ...
   // @PreAuthorize("hasAuthority('merchant:human-service:message:view')")
    @GetMapping("/messages")
    public CommonResult<PageInfo<MessageResponse>> getHumanServiceMessages(
   ...
   // @PreAuthorize("hasAuthority('merchant:human-service:message:detail')")
   ...
   // @PreAuthorize("hasAuthority('merchant:human-service:message:edit')")
   ...
   // @PreAuthorize("hasAuthority('merchant:human-service:message:delete')")
   ...
   // @PreAuthorize("hasAuthority('merchant:human-service:session:view')")
    @GetMapping("/sessions")
   ...
   // @PreAuthorize("hasAuthority('merchant:human-service:statistics:view')")
  ...
  //  @PreAuthorize("hasAuthority('merchant:human-service:statistics:view')")
    ...
    //@PreAuthorize("hasAuthority('merchant:human-service:rating:view')")
    @GetMapping("/ratings")
  ...
  //  @PreAuthorize("hasAuthority('merchant:human-service:rating:detail')")
   ...
   // @PreAuthorize("hasAuthority('merchant:human-service:rating:audit')")
   ...
   // @PreAuthorize("hasAuthority('merchant:human-service:rating:delete')")
   ...
   // @PreAuthorize("hasAuthority('merchant:human-service:rating:statistics')")
  ...
  //  @PreAuthorize("hasAuthority('merchant:human-service:template:view')")
    @GetMapping("/templates")
    public CommonResult<List<com.zbkj.common.model.service.QuickReplyTemplate>> getQuickReplyTemplates(
            ...
            @ApiParam(value = "每页数量") @RequestParam(defaultValue = "20") Integer size) {
        try {
            List<com.zbkj.common.model.service.QuickReplyTemplate> templates = 
                humanServiceService.getQuickReplyTemplates(category);
   ...
   // @PreAuthorize("hasAuthority('merchant:human-service:template:add')")
   ...
   // @PreAuthorize("hasAuthority('merchant:human-service:template:edit')")
   ...
   // @PreAuthorize("hasAuthority('merchant:human-service:template:delete')")
   ...
   // @PreAuthorize("hasAuthority('merchant:human-service:config:view')")
    @GetMapping("/config")
   ...
   // @PreAuthorize("hasAuthority('merchant:human-service:config:edit')")
    @PostMapping("/config")
   ...
   // @PreAuthorize("hasAuthority('merchant:human-service:contact:view')")
    @GetMapping("/contacts")
    public CommonResult<List<com.zbkj.common.model.service.ContactRelationship>> getContacts(
            ...
            @ApiParam(value = "关键词") @RequestParam(required = false) String keyword) {
        try {
            List<com.zbkj.common.model.service.ContactRelationship> contacts;
            
            if (keyword != null && !keyword.trim().isEmpty()) {
                contacts = contactRelationshipService.searchContacts(keyword);
            } else {
                contacts = contactRelationshipService.getContactList(contactType, groupName);
            }
   ...
   // @PreAuthorize("hasAuthority('merchant:human-service:contact:add')")
    @PostMapping("/contacts")
    public CommonResult<String> addContact(@RequestBody com.zbkj.common.request.ContactManageRequest request) {
        try {
            com.zbkj.common.model.service.ContactRelationship contact = contactRelationshipService.addContact(request);
            return CommonResult.success("添加成功");
        } catch (Exception e) {
            log.error("添加联系人失败", e);
            return CommonResult.failed("添加失败：" + e.getMessage());
   ...
   // @PreAuthorize("hasAuthority('merchant:human-service:contact:edit')")
   ...
   // @PreAuthorize("hasAuthority('merchant:human-service:contact:delete')")
    ...
    //@PreAuthorize("hasAuthority('merchant:human-service:contact:pin')")
    @PutMapping("/contacts/{contactId}/pin")
    public CommonResult<String> pinContact(
            @ApiParam(value = "联系人ID") @PathVariable Long contactId,
            @RequestBody Map<String, Object> pinData) {
        try {
            Boolean pinned = (Boolean) pinData.get("pinned");
   ...
   // @PreAuthorize("hasAuthority('merchant:human-service:contact:status')")
    ...
    // @PreAuthorize("hasAuthority('merchant:human-service:staff:list')")
    @GetMapping("/staff")
    ...
    //  @PreAuthorize("hasAuthority('merchant:human-service:staff:available')")
    ...
    //  @PreAuthorize("hasAuthority('merchant:human-service:staff:add')")
    @PostMapping("/staff")
    ...
    // @PreAuthorize("hasAuthority('merchant:human-service:staff:update')")
    ...
    // @PreAuthorize("hasAuthority('merchant:human-service:staff:delete')")
